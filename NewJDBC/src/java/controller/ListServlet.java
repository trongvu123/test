...
public class ListServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        KindOfBookDAO k = new KindOfBookDAO();
        try {
            Account a = k.getAcc(username, password);
            if(a==null){
                String ms = "Username or password wrong!";
                request.setAttribute("messEr", ms);
