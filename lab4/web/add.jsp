                                ...
                                <div class="card-body p-4 p-md-5">
                                    ...
                                    <form action="add" method="post">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                <div class="form-outline">
                                                    <input type="text" id="lastName" name="first" class="form-control form-control-lg" />
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                <div class="form-outline datepicker w-100">
                                                    <input type="text" class="form-control form-control-lg" name="last" id="birthdayDate" />
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                <div class="form-outline">
                                                    <input type="text" id="emailAddress" name="age" class="form-control form-control-lg" />
